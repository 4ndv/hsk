...
var LearnCard = function LearnCard(props) {
  ...
  var renderAnswer = function renderAnswer(index, variant, correct) {
    ...
    var color = !isSelected ? 'light' : correctColor;
  ...
  }, "Space"), ' ', "Skip"), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Button"], {
    block: true,
    color: "secondary",
    onClick: function onClick() {
      return skip();
...
//# sourceMappingURL=learn.js.a724d54cf6cfbe253547.hot-update.js.map